...
shinyServer(function(input, output, session){
  ...
  # port_weight = reactiveValues(weight=append(rep(1/2,2), rep(0,10))) # naive diversification
  ...
  # output$tttest = renderPrint(as.data.frame(input$bt_table1()))
  ...
  #     
  #     ll = dim(rf_range)[1]
  #     return (rf_range[(ll-250):ll,])
  #     
  #     # ll = dim(ret_df)[1]
  #     # return (ret_df[(ll-250):ll,])
  #   })
  # })
  # 
  # 
  # output$tttest = renderPrint(as.data.frame(ratiobug()))
