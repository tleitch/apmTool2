...
shinyServer(function(input, output, session){
  ...
  getLiab <- reactive({
    switch (input$simuWay,
            "Bob Miller" = c(0,rep(0,5),rep(1,4),rep(0,11),rep(9,20)),
            "Mary Swanson" = c(0,rep(0,5),rep(2,4),rep(0,11),rep(9,20)),
            "The Kleins" = c(0,rep(0,5),rep(3,4),rep(0,11),rep(9,20)),
            "The Nichols" = c(0,rep(0,5),rep(4,4),rep(0,11),rep(9,20)),
  ...
  getCash <- reactive({
    switch (input$simuWay,
            "Bob Miller" = c(100,rep(1,40)),
            "Mary Swanson" = c(100,rep(1.2,40)),
            "The Kleins" = c(100,rep(1.4,40)),
            "The Nichols" = c(100,rep(2,40)),
